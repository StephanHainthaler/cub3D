...
/*   Updated: 2024/11/14 10:04:33 by shaintha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calculate_wall_height(t_player *p, t_rays *rays)
{
	...
	if (rays->side == 0)
		wall_dist = (rays->map_x - p->pos_x + (double)(1 - rays->step_x) / 2) / rays->dir_x;
	if (rays->side == 1)
		wall_dist = (rays->map_y - p->pos_y + (double)(1 - rays->step_y) / 2) / rays->dir_y;
